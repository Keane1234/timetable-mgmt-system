...
class EventApp():
    def __init__(self):
        ...
        self.tkMessageBox=tkinter.messagebox
        self.ttk=ttk
...
#==================================================================        
   #creating the menu bar
    ...
    def _msgBox(self):
        self.tkinter.messagebox.showinfo('About the App','This App is designed to create a schedule for the days of the week and the time with an hour between between the times.The schedule can be accessed by the days of the week')
#=====================================================================
...
#**************************************************************************************************************
        ...
        def viewPrint():
            ...
            tkinter.messagebox.showinfo("View","The View button shows all the Events")
        ...
        def clean():
            showbiz2.delete(1.0,END)
            tkinter.messagebox.showinfo("Clear","Please note that the clear button only cleans the display field but not the schedule. Please use 'DELETE EVENT' to delete any event")
    ...
    def addElement(self):
        def allEvent():
            tkinter.messagebox.showinfo("Created","Event Created")
...
#***********************************************************************************************************************
    def deleteEvent(self):
        def deleteMonday():
            result=tkinter.messagebox.askyesno("delete","Are you sure you want to delete Monday Event ?")
            if result is True:
                file_new=open("monday.txt","w").close()
                tkinter.messagebox.showinfo("Deleted","Monday Event(s) Deleted")
        def deleteTuesday():
            result=tkinter.messagebox.askyesno("delete","Are you sure you want to delete Tuesday Event ?")
            if result is True:
                file_new=open("tuesday.txt","w").close()
                tkinter.messagebox.showinfo("Deleted","Tuesday Event(s) Deleted")
            
        def deleteWednesday():
            result=tkinter.messagebox.askyesno("delete","Are you sure you want to delete Wednesday Event ?")
            if result is True:
                file_new=open("wednesday.txt","w").close()
                tkinter.messagebox.showinfo("Deleted","Wednesday Event(s) Deleted")
        def deleteThursday():
            result=tkinter.messagebox.askyesno("delete","Are you sure you want to delete thursday Event ?")
            if result is True:
                file_new=open("thursday.txt","w").close()
                tkinter.messagebox.showinfo("Deleted","Thursday Event(s) Deleted")
        def deleteFriday():
            result=tkinter.messagebox.askyesno("delete","Are you sure you want to delete Friday Event ?")
            if result is True:
                file_new=open("friday.txt","w").close()
                tkinter.messagebox.showinfo("Deleted","Friday Event(s) Deleted")
        def deleteSaturday():
            result=tkinter.messagebox.askyesno("delete","Are you sure you want to delete Saturday Event ?")
            if result is True:
                file_new=open("saturday.txt","w").close()
                tkinter.messagebox.showinfo("Deleted","Saturday Event(s) Deleted")
        def deleteSunday():
            result=tkinter.messagebox.askyesno("delete","Are you sure you want to delete Sunday Event ?")
            if result is True:
                file_new=open("sunday.txt","w").close()
                tkinter.messagebox.showinfo("Deleted","Sunday Event(s) Deleted")
        def deleteAllEvent():
            result=tkinter.messagebox.askyesno("delete","Are you sure you want to delete All Events ?")
            ...
            if result is True:
                ...
                tkinter.messagebox.showinfo("Deleted","All Events Deleted")
